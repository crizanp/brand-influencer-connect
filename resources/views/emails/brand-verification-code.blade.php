...
<head>
    ...
    <title>Brand Account Verification</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>Thank you for registering your brand with us! To complete your account setup and start connecting with influencers, please verify your email address using the verification code below:</p>
        ...
        <ul>
            <li>Browse and connect with influencers</li>
            <li>Create collaboration campaigns</li>
