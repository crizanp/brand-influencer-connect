...
<head>
    ...
    <title>Reset Password - Brand Account</title>
...
<body>
    <div class="auth-container">
        <div class="auth-card">
            ...
            <form method="POST" action="{{ route('brand.password.update') }}" class="auth-form">
                @csrf
            ...
            <div class="auth-links">
                <a href="{{ route('brand.password.request') }}">Request New Code</a>
                <span>|</span>
