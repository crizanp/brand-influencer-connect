...
<head>
    ...
    <title>Forgot Password - Influencer Account</title>
...
<body>
    <div class="auth-container">
        <div class="auth-card">
            ...
            <form method="POST" action="{{ route('influencer.password.email') }}" class="auth-form">
                @csrf
            ...
            <div class="auth-links">
                ...
                <span>|</span>
                <a href="{{ route('influencer.register') }}">Create Account</a>
            </div>
        </div>
    </div>
</body>
